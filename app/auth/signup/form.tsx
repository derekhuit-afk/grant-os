        ...
        <div className="bg-white rounded-xl p-8 shadow-2xl">
          ...
          {step === 'account' && (
            <form onSubmit={handleSignup} className="space-y-5">
              <button type="button" onClick={() => setStep('plan')} className="text-sm text-gray-500 hover:text-gray-700 mb-2">← Back</button>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-3 text-xs text-yellow-800 leading-relaxed">
                By creating an account you agree to our <Link href="/terms" target="_blank" className="underline">Terms of Service</Link> and <Link href="/privacy" target="_blank" className="underline">Privacy Policy</Link>. All AI-generated content requires mandatory user attestation before use.
              </div>
