    ...
    <div className="min-h-screen bg-[#0F2D1F] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-sm text-gray-500">
              No account?{' '}
              <Link href="/auth/signup" className="text-[#3B6E50] font-semibold hover:underline">
                Request access →
              </Link>
            </p>
          </div>
        ...
        <p className="text-center text-white/30 text-xs mt-8 max-w-sm mx-auto leading-relaxed">
          Grant OS is a paid subscription service. All AI-generated content requires user attestation before use. See{' '}
